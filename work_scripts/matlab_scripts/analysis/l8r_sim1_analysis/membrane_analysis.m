...
current_peptide_residue_list = {'1THR', '2ARG', '3SER', '4SER', '5ARG', '6ALA', '7GLY', '8ARG', '9GLN', '10TRP', '11PRO', '12VAL', '13GLY', '14ARG', '15VAL', '16HIS', '17ARG', '18LEU', '19LEU', '20ARG', '21LYS'}; % What are the residue names in order
current_residue_one_letter_code = {'T','R','S','S','R','A','G','R','Q','W','P','V','G','R','V','H','R','L','L','R','K'};
